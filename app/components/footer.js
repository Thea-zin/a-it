  ...
  return (
    <footer className="lg:grid lg:grid-cols-3 sm:flex-col xsm:flex-col min-w-[500px] w-full h-[150px] bg-black p-7 content-center lg:text-body-md md:body-sm sm:body-sm x xsm:text-body-sm ">
      <div className="space-y-3 lg:col-span-2 md:col-span-2  mt-[10%] lg:mb-[10%]">
        ...
        {/* <div className="space-y-[70px] ">
          <div className="space-x-5">
            <Link
              href="/vendors"
              className="underline decoration-white text-white"
            >
              Categories
            </Link>
      ...
      {/* <div className="sm:block space-y-[70px] lg:mt-[35%] md:mt-[20%] sm:mt-[10%] xsm:mt-[20%]">
        <p className="text-white text-center sm:text-title-md xsm:text-[22px] font-bold">
          Stay up to date
        </p>
        <div className="text-center ">
          <div className="flex justify-center">
            <input
              type="email"
              className="p-2 absolute sm:w-1/2 md:w-1/2 lg:w-auto bg-basedark"
              placeholder="Email Address"
            ></input>
            <button className="relative mt-[10px] lg:ml-[40%] md:ml-[50%] sm:ml-[40%] xsm:ml-[30%] ">
