        ...
        <div className="flex justify-center items-center p-4">
            <div className=" w-[65%] border bg-base rounded-[16px]  lg:p-20 md:p-10 sm:p-7 xsm:p-8 ">
                ...
                <div className="flex justify-center">
                    <input type='text' className="border p-4 border-basedark rounded-full w-[70%]" placeholder="First Name"></input>
                </div>   
                <div className="flex justify-center">
                    <input type='text' className="border p-4 border-basedark rounded-full w-[70%]" placeholder="Last Name"></input>
                </div>   
                <div className="flex justify-center">
                ...
                <div className="flex justify-center relative">
                    ...
                    <button onClick={showPassword} className="absolute lg:mt-3 xsm:mt-[17px] lg:ml-[57%] md:ml;[50%] xsm:ml-[50%]">{isOpen?<p className="text-basedark">show</p >:<p className="text-basedark">hide</p >}</button>
                </div>
