...
export default function TapSoftwareComponent() {
  ...
  return (
    <div className="text-white xl:ml-44 lg:ml-32 text-[1.15rem] font-medium">
      <div className="flex">
        <button
          className={`border-t-2 border-x-2 border-darkblue rounded-t-xl py-1 xm:py-2 px-3 xm:px-5 mr-2 xm:mr-5 text-xs xm:text-[1rem] ${
        ...
        <button
          className={`border-t-2 border-x-2 border-darkblue rounded-t-xl py-1 xm:py-2 px-3 xm:px-5 text-xs xm:text-[1rem] ${
