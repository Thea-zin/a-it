export default function ReviewForm3() {
  return (
    <div className="w-full font-dmsan">
      ...
      <div className="px-10">
        <p className="mt-10">
          <span className="text-red-600">* </span>At which organization did you most recently use ChatGPT?
        </p>
        <div className="mt-5">
          <input
            type="text"
        ...
        <p className="mt-10">
          <span className="text-red-600">* </span>What was the URL of the organization where you most recently used
          ChatGPT?
        </p>
        <div className="mt-5">
          <input
        ...
        <p className="mt-10">
          <span className="text-red-600">* </span>How many people use ChatGPT in your organization?
        </p>
        <div className="mt-5">
          <select
        ...
        <div className="mt-10">
          <p><span className="text-red-600">* </span>What is your primary role when using ChatGPT?</p>
        ...
        <div className="mt-10">
          <p>
            <span className="text-red-600">* </span>Are you affiliated with the product you are reviewing or the
