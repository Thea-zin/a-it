...
import ReviewForm1 from "./components/review_form_1";
import ReviewForm2 from "./components/review_form_2";
import ReviewForm3 from "./components/review_form_3";
...
export default function WriteReviewPage() {
  ...
  switch (showForm) {
    case 1:
      return <ReviewForm1 setShowForm={setShowForm} />;
      break;
    case 2:
      return <ReviewForm2 setShowForm={setShowForm} />;
      break;
    case 3:
      return <ReviewForm3 setShowForm={setShowForm} />;
      break;
    default:
      return (
            ...
            <div className="grid md:grid-cols-2">
              <div className="pt-6 xl:ml-24 xl:mr-44 lg:ml-12 grid place-content-center">
                ...
                <button
                  ...
                  className="bg-[#2F455C] w-full lg:p-4 p-3 rounded-[500px] mt-5 lg:text-2xl text-xl"
                >
                  Write a review
                </button>
              </div>
              <div className="mt-5 md:mt-14 lg:mx-24 mx-10">
                ...
                <p className="lg:text-2xl text-xl mt-6 text-center">
                  Help million of people make the right choice for their
                  business.
                </p>
              </div>
            </div>
