    ...
    <div>
      <div className="content-top bg-black h-44 ">
        <div className="text flex justify-between p-4">
            <div className='text-[#1DCDFE] font-semibold text-3xl mt-9 ml-7'>Marketing</div>
            <div className='bg-white flex h-9 w-96 rounded-full p-2 mt-9 '>    
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" placeholder="Search Mockups, Logos...">
      ...
      <div className=" pl-8 ">
            <div className="btn">
                <button className='bg-white border-solid border-white border-2 p-3 rounded-lg -translate-y-11 text-black ml-3'>Overview</button>
                <button className='border-solid border-white border-2 p-3 rounded-lg -translate-y-11 text-white ml-3'>Products</button>
        ...
        <div className=" grid grid-col-6 gap-2 p-8 ml-5">
            <div className='w-80'>
                    <div className="filter  bg-white rounded-xl p-8 ">
                        <div className='flex justify-between '>
                            ...
                            <div className='font-medium text-xs items-center text-[#4A4A4A] border-b-2- '><button>Reset Filter</button></div>
                        ...
                        <div className='software mt-5'>
                            ...
                            <div className='checkbox mt-5'>
                                    <div class="flex items-center mb-2">
                                        ...
                                        <label for="default-checkbox" class="ml-2 text-sm font-medium text-[#EDA42D] dark:text-gray-300 bg-[#2F455C] flex items-center p-1 rounded-lg">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 ">
                                                <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" />
                                            </svg>
                        ...
                        <div className="title mt-5 font-semibold">Business type</div>
                            <div className='checkbox mt-5'>
                                    <div class="flex items-center mb-2">
                                        <input id="default-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-full focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                        <label for="default-checkbox" class="ml-2 text-sm font-medium text-[#EDA42D] dark:text-gray-300 flex items-center p-1 rounded-lg">
                    ...
                    <div className='filter  bg-white rounded-b-xl p-8'>
                            <div className='grid grid-cols-1 gap-4 mt-5'>
                                <input type="text" className='w-full h-9 rounded-full border-solid border-2 border-[#4b5563] placeholder-[#6b7280] p-5' placeholder='Name*'/>
                                <input type="text" className='w-full h-9 rounded-full border-solid border-2 border-[#4b5563] placeholder-[#6b7280] p-5' placeholder='Email*'/>
                                <div className='flex rounded-full border-solid border-2 border-[#4b5563] p-2'>
                                     <img src="../photo/icon/cambodia.png" alt="" className='border-r-2 border-solid border-[#4b5563] mr-5 p-1 ' />
                                    <input type="text" className='w-full  placeholder-[#6b7280] ' placeholder='Mobile Phone *'/>
                                </div> 
                                
                            </div>
                            <div className='btn mt-5'>
                                <button className='bg-[#2F455C] p-3 rounded-full w-full text-white font-semibold'>Get Offer</button>
                            </div>
                            <div className="text text-sm mt-3 text-center">
                                <p>By submitting, you agree to our <span className='text-[#005FC1]'>Terms and Condition</span> and <span className='text-[#005FC1]'> Privacy Policy</span> </p>
                            </div>
                    </div>
            ...
            <div className="col-start-2 col-span-2 ">
                <div className="text p-5">
                  <div className='font-bold text-2xl'>Best Content Marketing Software</div>
