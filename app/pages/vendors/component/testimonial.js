...
function Testimonial(){
    ...
    const testimonialList=[
        {heading:"Customer Success",icon:"../vendors/flat-color-icons_debt.png",factors:["Strengthen Engagement","Extended customer support","improve service and product faster"],summary:"Reviews improve product and service quality, making it easier to understand and increase customer satisfaction. They also represent the voices of the silent majority and customers who don’t usually speak up."},
        {heading:"Sales",icon:"../vendors/flat-color-icons_bullish.png",factors:["Enhancing Advantages","More business opportunity","Self-serve rate UP"],summary:"Your service’s strengths will be clarified, leading to the acquisition of appropriate target customers. Additionally, you can gain market recognition, compete beyond price competition, and reduce order lead time."},
        {heading:"Marketing",icon:"../vendors/flat-color-icons_stack-of-photos.png",factors:["Organic exposure expansion","Greater negotiation opportunities","Strengthen and renew branding"],summary:"Reviews improve product and service quality, making it easier to understand and increase customer satisfaction. They also represent the voices of the silent majority and customers who don’t usually speak up."}
    ]
    return(
        <div className="p-4 ">
          <div className="text-center space-y-2">
              ...
              <div className="grid  lg:grid-cols-3 p-4 md:grid-cols-3 sm:grid-cols-1 lg:space-x-3  ">
              {
                testimonialList.map((datas)=>(
                    ...
                    <div className="border-2 space-y-3 border-stroke p-10 mt-5 bg-white rounded-[16px]  ">
