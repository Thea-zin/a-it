    ...
    return(
        <div >
            ...
            <div className="box-border h-auto w-full bg-cyan p-10   rounded-[16px] space-y-5">
                ...
                <div ><button className="bg-darkblue hover:bg-darkblue_hover text-white p-3 rounded-full w-full lg:text-[24px] md:text-[20px] sm:text-[15px] xsm:text-[13px] " onClick={openPopUp} >Make a booking</button></div>
           </div>
           </div>
