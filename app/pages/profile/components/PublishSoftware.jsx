...
export default function PublishSoftware() {
  return (
    <div>
      ...
      <div>
        <div>
          <label htmlFor="seviceName">{"Software/Service's Name *"}</label>
          <br />
          <input type="text" id="serviceName" />
        </div>
        <div>
          <label htmlFor="seviceName">Description *</label>
          <br />
          <input type="text" id="serviceName" />
        </div>
        <div className="flex place-content-between">
          <div>
            <label htmlFor="seviceName">Category *</label>
            <br />
            <input type="text" id="serviceName" />
          </div>
          <div>
            <label htmlFor="seviceName">Company</label>
            <br />
            <input type="text" id="serviceName" />
          </div>
        </div>
